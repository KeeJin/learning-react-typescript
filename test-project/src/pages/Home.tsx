...
const GamepadComponent: React.FC = () => {
    ...
    const [gamepadInputValue, setGamepadInputValues] = useState<GamepadInputData | null>(null);
            ...
            {gamepad ? (
                <div>
                    ...
                    {gamepadInputValue !== null ? (
                        <div>
                            <AxisVisualizer label="Axis 0: " axisValue={gamepadInputValue.axes[0]} />
                            <AxisVisualizer label="Axis 1: " axisValue={gamepadInputValue.axes[1]} />
                            <AxisVisualizer label="Axis 2: " axisValue={gamepadInputValue.axes[2]} />
                            <AxisVisualizer label="Axis 3: " axisValue={gamepadInputValue.axes[3]} />
                            <div className='flex justify-center text-xl font-semibold'>
                                <p className='mr-4 text-center'>Button 0: {gamepadInputValue.buttons[0].value}</p>
                                <p className='mr-4 text-center'>Button 1: {gamepadInputValue.buttons[1].value}</p>
                                <p className='mr-4 text-center'>Button 2: {gamepadInputValue.buttons[2].value}</p>
                                <p className='mr-4 text-center'>Button 3: {gamepadInputValue.buttons[3].value}</p>
                            </div>
                        </div>) : (<p>null</p>)}
                </div>
            ) : (
